# Tolino Vision 4 HD (E60Q50) device tree
...
3. clone this repo to <twrp_repo>/device/TOLINO/VISION_4HD
4. apply patches from <twrp_repo>/device/TOLINO/VISION_4HD/patches directory
5. open terminal in <twrp_repo> directory;
6. . build/envsetup.sh
7. breakfast VISION_4HD
8. mka recoveryimage

if everything is successful you should find built recovery by path <twrp_repo>/out/target/product/VISION_4HD/recovery.img
